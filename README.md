...
- [Run This Container](#run-this-container)
  - [Docker](#docker)
    - [Start a Postgres Container](#start-a-postgres-container)
    - [Start an Odoo Container](#start-an-odoo-container)
  - [Docker Compose](#docker-compose)
  - [Logging into Your Container](#logging-into-your-container)
...
- [Extending This Image](#extending-this-image)
  ...
  - [Running Your Image with Docker Compose](#running-your-image-with-docker-compose)
  - [Note: Python Virtualenv](#note-python-virtualenv)
- [Extending This Image with Odoo Enterprise](#extending-this-image-with-odoo-enterprise)
  - [Odoo Partners](#odoo-partners)
  - [Downloaded Enterprise](#downloaded-enterprise)
- [Configure Your Odoo Instances](#configure-your-odoo-instances)
  - [Default Odoo Configuration File](#default-odoo-configuration-file)
  - [Configure Default Options](#configure-default-options)
    - [Docker](#docker-2)
    - [Docker Compose](#docker-compose-2)
- [Use Your Own odoo.conf](#use-your-own-odooconf)
  - [Step 1: Create an odoo.conf File](#step-1-create-an-odooconf-file)
  - [Step 2: Mount the Configuration File](#step-2-mount-the-configuration-file)
    - [Docker](#docker-3)
    - [Docker Compose](#docker-compose-3)
- [Environment Variable Defaults](#environment-variable-defaults)
- [Building Default Configuration into the Image](#building-default-configuration-into-the-image)
- [Setup Hook](#setup-hook)
- [Development with This Container](#development-with-this-container)
  - [Use This Container as a Development Environment w/ Breakpoints](#use-this-container-as-a-development-environment-w-breakpoints)
- [Debugging the Generated Config](#debugging-the-generated-config)
- [Maintaining This Repository](#maintaining-this-repository)
  - [Adding a New Version of Odoo](#adding-a-new-version-of-odoo)
  - [Testing](#testing)
    - [Unit Tests](#unit-tests)
    - [Front End Testing & Tours](#front-end-testing--tours)
- [License](#license)
